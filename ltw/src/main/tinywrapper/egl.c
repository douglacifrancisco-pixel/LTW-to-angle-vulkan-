...
__attribute__((visibility("default"), used)) EGLDisplay eglGetDisplay(EGLNativeDisplayType display_id) {
    static EGLDisplay (*func)(EGLNativeDisplayType) = NULL;
    if (!func) func = (EGLDisplay (*)(EGLNativeDisplayType))host_eglGetProcAddress("eglGetDisplay");
    return func ? func(display_id) : EGL_NO_DISPLAY;
}

__attribute__((visibility("default"), used)) EGLBoolean eglInitialize(EGLDisplay dpy, EGLint *major, EGLint *minor) {
    static EGLBoolean (*func)(EGLDisplay, EGLint*, EGLint*) = NULL;
    if (!func) func = (EGLBoolean (*)(EGLDisplay, EGLint*, EGLint*))host_eglGetProcAddress("eglInitialize");
    return func ? func(dpy, major, minor) : EGL_FALSE;
}

__attribute__((visibility("default"), used)) EGLBoolean eglTerminate(EGLDisplay dpy) {
    static EGLBoolean (*func)(EGLDisplay) = NULL;
    if (!func) func = (EGLBoolean (*)(EGLDisplay))host_eglGetProcAddress("eglTerminate");
    return func ? func(dpy) : EGL_FALSE;
}

__attribute__((visibility("default"), used)) EGLBoolean eglChooseConfig(EGLDisplay dpy, const EGLint *attrib_list, EGLConfig *configs, EGLint config_size, EGLint *num_config) {
    static EGLBoolean (*func)(EGLDisplay, const EGLint*, EGLConfig*, EGLint, EGLint*) = NULL;
    if (!func) func = (EGLBoolean (*)(EGLDisplay, const EGLint*, EGLConfig*, EGLint, EGLint*))host_eglGetProcAddress("eglChooseConfig");
    return func ? func(dpy, attrib_list, configs, config_size, num_config) : EGL_FALSE;
}

__attribute__((visibility("default"), used)) EGLint eglGetError(void) {
    static EGLint (*func)(void) = NULL;
    if (!func) func = (EGLint (*)(void))host_eglGetProcAddress("eglGetError");
    return func ? func() : 0x3000;
}

__attribute__((visibility("default"), used)) const char* eglQueryString(EGLDisplay dpy, EGLint name) {
    static const char* (*func)(EGLDisplay, EGLint) = NULL;
    if (!func) func = (const char* (*)(EGLDisplay, EGLint))host_eglGetProcAddress("eglQueryString");
    return func ? func(dpy, name) : NULL;
}

__attribute__((visibility("default"), used)) EGLSurface eglCreateWindowSurface(EGLDisplay dpy, EGLConfig config, EGLNativeWindowType win, const EGLint *attrib_list) {
    static EGLSurface (*func)(EGLDisplay, EGLConfig, EGLNativeWindowType, const EGLint*) = NULL;
    if (!func) func = (EGLSurface (*)(EGLDisplay, EGLConfig, EGLNativeWindowType, const EGLint*))host_eglGetProcAddress("eglCreateWindowSurface");
    return func ? func(dpy, config, win, attrib_list) : EGL_NO_SURFACE;
}

__attribute__((visibility("default"), used)) EGLSurface eglCreatePbufferSurface(EGLDisplay dpy, EGLConfig config, const EGLint *attrib_list) {
    static EGLSurface (*func)(EGLDisplay, EGLConfig, const EGLint*) = NULL;
    if (!func) func = (EGLSurface (*)(EGLDisplay, EGLConfig, const EGLint*))host_eglGetProcAddress("eglCreatePbufferSurface");
    return func ? func(dpy, config, attrib_list) : EGL_NO_SURFACE;
}

__attribute__((visibility("default"), used)) EGLBoolean eglDestroySurface(EGLDisplay dpy, EGLSurface surface) {
    static EGLBoolean (*func)(EGLDisplay, EGLSurface) = NULL;
    if (!func) func = (EGLBoolean (*)(EGLDisplay, EGLSurface))host_eglGetProcAddress("eglDestroySurface");
    return func ? func(dpy, surface) : EGL_FALSE;
}

__attribute__((visibility("default"), used)) EGLBoolean eglSwapBuffers(EGLDisplay dpy, EGLSurface surface) {
    static EGLBoolean (*func)(EGLDisplay, EGLSurface) = NULL;
    if (!func) func = (EGLBoolean (*)(EGLDisplay, EGLSurface))host_eglGetProcAddress("eglSwapBuffers");
    return func ? func(dpy, surface) : EGL_FALSE;
}

__attribute__((visibility("default"), used)) EGLContext eglGetCurrentContext(void) {
    static EGLContext (*func)(void) = NULL;
    if (!func) func = (EGLContext (*)(void))host_eglGetProcAddress("eglGetCurrentContext");
    return func ? func() : EGL_NO_CONTEXT;
}

__attribute__((visibility("default"), used)) EGLDisplay eglGetCurrentDisplay(void) {
    static EGLDisplay (*func)(void) = NULL;
    if (!func) func = (EGLDisplay (*)(void))host_eglGetProcAddress("eglGetCurrentDisplay");
    return func ? func() : EGL_NO_DISPLAY;
}

__attribute__((visibility("default"), used)) EGLSurface eglGetCurrentSurface(EGLint readdraw) {
    static EGLSurface (*func)(EGLint) = NULL;
    if (!func) func = (EGLSurface (*)(EGLint))host_eglGetProcAddress("eglGetCurrentSurface");
    return func ? func(readdraw) : EGL_NO_SURFACE;
}

// Force symbol retention - prevents LTO/gc-sections from stripping these
__attribute__((constructor, used)) static void force_egl_symbol_retention(void) {
    volatile void* refs[] = {
        (void*)eglGetDisplay, (void*)eglInitialize, (void*)eglTerminate,
        (void*)eglChooseConfig, (void*)eglGetError, (void*)eglQueryString,
        (void*)eglCreateWindowSurface, (void*)eglCreatePbufferSurface,
        (void*)eglDestroySurface, (void*)eglSwapBuffers,
